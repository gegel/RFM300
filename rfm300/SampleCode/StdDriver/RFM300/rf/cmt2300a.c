...
BOOL CMT2300A_IsExist(void)
{
	...
	// testa=CMT2300A_ReadReg(CMT2300A_CUS_PKT17);
  //if(test==0x00) als1();	
...
//set one byte Node ID will be transmitted and filtering receiving
//0 is wide-spred id and transmitted packets with id=0 will be received
//undepending of presetted node id on receiving side
